...
MySQL - 5.5.20-log : Database - c_binr
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`c_binr` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `branches`(`branch_id`,`username`,`branch_name`,`latitude`,`longitude`,`phone`,`email`) values 
(1,'vypin','vypin','9.988800214678564','76.27249717712402','9876546543','vishnu@gmail.com'),
(2,'kochi','kochi','9.988293036447752','76.28811836242676','9876546543','buyer@gmail.com');
...
insert  into `customers`(`customer_id`,`username`,`first_name`,`last_name`,`phone`,`email`,`latitude`,`longitude`) values 
(1,'customer','customer','wer','9876546543','buyer@gmail.com','9.976712251779837','76.28459930419922');
...
insert  into `deliveryboys`(`boy_id`,`username`,`first_name`,`last_name`,`branch_id`,`phone`,`email`) values 
(1,'vypindboy','vypindboy','hh',1,'9876546543','wells@gmail.com'),
(2,'kochidboy','KOCHIDBOY','xdfg',2,'9876546543','joyelroy24@gmail.com');
...
('vypin','vypinvypin','branch'),
('kochi','kochikochi','branch'),
('vypindboy','vypindboy','dboy'),
('kochidboy','dboyk','dboy'),
('kochinstaff','vsta','staff'),
('vypinstaff','vypinstaff','staff');
...
insert  into `prices`(`price_id`,`maximum_weight`,`maximum_height`,`maximum_width`,`maximum_distance`,`minimum_price`,`pstatus`) values 
(1,'500','55','666','55','10000','active');
...
insert  into `staffs`(`staff_id`,`username`,`first_name`,`last_name`,`branch`,`phone`,`email`) values 
(1,'kochinstaff','KOCHISTAFF','TT',2,'9876546543','joyelroy24@gmail.com'),
(2,'vypinstaff','VYPINSTAFF','fs',1,'9876546543','vishnu@gmail.com');
